...
ggsave(  '../results/Supplementary_figures/F_S6/Fig_S6_a_with_numbers.pdf', device='pdf', dpi=900)
...
ggsave('../results/Supplementary_figures/F_S6/Fig_S6_a_without_numbers.pdf', device='pdf', dpi=900)
